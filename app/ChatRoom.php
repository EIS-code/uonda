...
class ChatRoom extends BaseModel
{
    ...
    public function validators(array $data, $returnBoolsOnly = false)
    {
        $validator = Validator::make($data, [
            ...
            'group_icon'        => ['nullable', 'mimes:' . implode(",", $this->allowedExtensions), 'max:6000'],
            'group_icon_actual' => ['nullable', 'mimes:' . implode(",", $this->allowedExtensions), 'max:6000'],
            'group_icon'        => ['nullable', 'max:6000'],
            'group_icon_actual' => ['nullable', 'max:6000'],
