    ...
    public function toMail($notifiable)
    {
        ...
        if (empty($emailTemplate)) {
            return (new MailMessage)
                    ...
                    ->line('You are receiving this email because we received a verify email request for your account. Click the button below to verify your Email')
                    ->action('Verify Email', url('api/email/verify', $this->token))
        ...
        $actionUrl  = url('api/email/verify', $this->token);

        $emailBody  = str_ireplace('{{verify_link_url}}', $actionUrl, $emailBody);
