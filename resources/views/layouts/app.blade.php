...
<head>
    ...
    <link href="{{ asset('css/fonts-nunito-google.css') }}" rel="stylesheet">
    <link href="{{ asset('css/fonts-material-icons-google.css') }}" rel="stylesheet">
                            ...
                            <div class="widget-content-wrapper">
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        ...
                                        <img width="42" class="rounded-circle" src="{{ Auth::user()->getProfileAttribute(Auth::user()->getAttributes()['profile']) }}" alt="">
