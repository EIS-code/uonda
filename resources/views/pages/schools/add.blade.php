...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form id="addFeedsForm" class="col-md-10 mx-auto" method="post" action="{{ route('schools.store') }}" enctype="multipart/form-data">
        @csrf
            <div class="form-group">
                <label for="title">Name</label>
                <div>
                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" placeholder="Title" value="{{ old('name') }}" />
                    @error('name')
