    ...
    <div class="card-body">
        ...
        {{ method_field('PUT') }}
            ...
            <div class="form-group">
                ...
                <div>
                    <input type="text" class="form-control @error('expiry_date') is-invalid @enderror" id="expiry_date" name="expiry_date" placeholder="Expiry Date" value="{{ $promotion->formatted_expiry_date }}" data-toggle="datepicker"/>
                    @error('expiry_date')
                        <em class="error invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </em>
